...
using System;
namespace ApiSdk.ResetPassword
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.ResetPassword.ResetPasswordRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> PostAsync(global::ApiSdk.Models.ResetPasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> PostAsync(global::ApiSdk.Models.ResetPasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.ResetPasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.ResetPasswordRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.ResetPassword.ResetPasswordRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ApiSdk.ResetPassword.ResetPasswordRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ApiSdk.ResetPassword.ResetPasswordRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
